...
def fusion_contour(imgpath1, imgpath2):
    ...
    shutil.copy(imgpath1, FUSIONPATH1)
    shutil.copy(imgpath2, FUSIONPATH2)
    ...
    def overlay(largeImg, smallImg, regionTopLeftPos = (0,0)):
        ...
        if (refW > srcW) or (refH > srcH):
            ...
            for y in range(refH):
                for x in range(refW):
                    tmpImg[y,x] = min(smallImg[y,x], tmpSrcImg[y,x])
